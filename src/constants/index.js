...
export const workExperiences = [
  ...
  {
    id: 1,
    name: 'Cyber Infrastructure (P) Ltd',
  ...
  },
  {
    ...
    title: `• Designed a full-stack Employee Management System using the MERN stack with end-to-end functionality from frontend UI to backend APIs.`,
